<template>
  <div class="bg-white dark:bg-zinc-900 xl:dark:bg-zinc-800 rounded pb-1">
    ...
    >
      ...
      <!-- 遮罩层 -->
      <div
        class="opacity-0 w-full h-full bg-zinc-900 absolute top-0 left-0 rounded duration-300 group-hover:bg-opacity-50 group-hover:opacity-100 xl:block"
        v-show="!isMobile"
      >
        <!-- 分享 -->
        ...
        <m-button
          ...
          type="info"
          icon="heart"
          iconClass="fill-zinc-900"
        ></m-button>
        <!-- 下载 -->
        <m-button
          class="absolute bottom-1.5 left-1.5 bg-zinc-100 bg-opacity-70"
          type="info"
          size="small"
          icon="download"
          iconClass="fill-zinc-900"
        ...
        <!-- 全屏 -->
        <m-button
          class="absolute bottom-1.5 right-1.5 bg-zinc-100 bg-opacity-70"
          type="info"
          size="small"
          icon="full"
          iconClass="fill-zinc-900"
    ...
    <!-- 标题 -->
    <p class="text-sm mt-1 font-bold text-zinc-900 px-1 dark:text-zinc-300">
      {{ data.title }}
    </p>
    <!-- 作者信息 -->
